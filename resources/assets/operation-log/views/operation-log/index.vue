    ...
    <el-card>
      ...
      <div class="filter-container">
        ...
        <el-row :gutter="10">
          ...
          <el-col :md="3" :sm="3">
            <div>
              <el-button v-waves class="filter-item" type="danger" :disabled="!checkPermission(['larke-admin.operation-log.clear'])" icon="el-icon-delete" @click="handleClear" style="width: 100%;">
                {{ $t('清空') }}
              </el-button>
            </div>            
          </el-col>  
